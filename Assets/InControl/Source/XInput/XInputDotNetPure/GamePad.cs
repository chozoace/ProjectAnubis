	...
	public struct GamePadState
	{
		...
		internal GamePadState( bool isConnected, RawState rawState )
		{
			...
			thumbSticks = new GamePadThumbSticks(
				new GamePadThumbSticks.StickValue( rawState.Gamepad.sThumbLX, rawState.Gamepad.sThumbLY ),
				new GamePadThumbSticks.StickValue( rawState.Gamepad.sThumbRX, rawState.Gamepad.sThumbRY )
			);

			triggers = new GamePadTriggers( rawState.Gamepad.bLeftTrigger, rawState.Gamepad.bRightTrigger );
		}
